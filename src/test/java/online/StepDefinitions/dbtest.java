...
//		  //String firstName = "Tosjoy"; String
		...
		//MsSqlUtility.UpdateLoanStatussplil("robinfsmil@yopmail.com", 6);
		
		MsSqlUtility obj=new MsSqlUtility();
		obj.getDbConnection2();
		String opt=obj.getOnlineOTP( "robinlchig@yopmail.com");
		System.out.println(opt); 

		       // System.out.println(UtilityMethods.getDOB(1970, 1980));
		        //System.out.println(UtilityMethods.getDOB(1970, 1971));
		        //System.out.println(UtilityMethods.getDOB(2007, 2016));
