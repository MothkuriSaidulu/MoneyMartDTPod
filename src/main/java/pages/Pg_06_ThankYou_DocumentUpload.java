...
public class Pg_06_ThankYou_DocumentUpload extends OnlineActions {
	...
	//Thank you page
	//@FindBy (how=How.XPATH, using = "//h1[normalize-space()='Thank You for your Application!']")
	//public static WebElement txt_ThankYou;
	//@FindBy (how=How.XPATH, using = "//button[@class='mm-btn mm-btn--lg']")
...
//	public static WebElement btn_Upload;
	...
	@FindBy (how=How.XPATH, using = "(//div[contains(@class,'mm-radio-menu__item mm-radio-menu__item--active')]//input[contains(@type,'file')])[1]")  //new dt change 10/17/2022 chandu
	public static WebElement Upload_pic;
	
	@FindBy (how=How.XPATH, using = "//button[normalize-space()='Submit document(s)']")  // DTpod new change 10/17/2022 chandu
	public static WebElement btn_Upload;
	...
	@FindBy (how=How.XPATH, using = "//button[normalize-space()='Go to Dashboard']")
	...
	{
		Thread.sleep(9000);
		waitForElementToBeVisible(btn_UploadDocs, "wait for upload button");
		Thread.sleep(9000);
