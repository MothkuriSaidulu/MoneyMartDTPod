...
//	
	...
	//added code start 0419 Revised
	@FindBy (how=How.XPATH, using = "//div[@class='signInSignUpLink']/span")
	public static WebElement signup_msg;
	
	//added code close 0419 Revised
	...
	public void click_signup() throws Exception
	{
		...
		//Thread.sleep(3000);
		//Added on 19-Apr-2023 start Revised
		VerifyText_For_PageCaption(signup_msg, "Don't have an account? ","Don't have an account? , Hence passed");
		//Added on 19-Apr-2023 End Revised
		Thread.sleep(5000);
		
		waitForElementToBeClickable(signup, "signup");
...
public void Dashboard_click_SPL() throws Exception
	...
	Thread.sleep(3000);
	waitForElementToBeVisible(Dash_SPL_Apply,"WaitVisibleOfInstallment displayed");
	Thread.sleep(3000);
