...
public class Pg_07_Dashboard extends OnlineActions {
	...
	//@FindBy(how=How.XPATH, using = "//strong[normalize-space()='Application in Progress']")
	@FindBy(how=How.XPATH, using = "//strong[normalize-space()='Action Required']") //new ui change 11/24/22 Madhu
	...
	//@FindBy(how=How.XPATH, using = "//div[@title='Finalize and e-Sign Loan Documents']")
	//@FindBy(how=How.XPATH, using = "//div[//*[@id="root"]/div/div[2]/div/div/div[2]/div/div/div/div[2]/div[1]/div/div[3]/div[1]/div[3]/button']")
	//
	@FindBy(how=How.XPATH, using = "//button[@class='mm-btn mm-btn--primary mm-btn--loan button']")
	//@FindBy(how=How.XPATH, using = "//button[text()='Finalize and e-Sign Loan Documents']") //new ui change 11/24/22 Madhu
...
//		SoftVerifyTextOnly(PaymentDue, formattedDate, "Payment due date compared from Final offer page and Dashboard after Loan");
	...
	public static void click_esign() throws Exception
	{
		...
		//Loan_Btn2 = Custom_List_Dash_Button2_LoanCount_01.get(1).getText();
		if(Loan_Status.equalsIgnoreCase("Action Required")&&Loan_Btn1.equalsIgnoreCase("Withdraw Loan Application"))
		{
			PrintValueToReport("Loan application is updated after CRM approval", "Loan application status");
			PrintValueToReport(Loan_Status, "Loan Status After CRM approval(Online application refreshed for update loan status) ");	
