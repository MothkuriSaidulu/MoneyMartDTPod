##Scenario: Test Case 91406: TC_01_IL_Verify the Date Picker "Icon" functionality in About you screen

Feature: CAN_Online_TC40_IL_Approved_Datepicker
  @ILApprovedd
  Scenario: Online_New Customer_IL_Approved|TC40_IL_Approved_Datepicker
     Given Genareted sin
