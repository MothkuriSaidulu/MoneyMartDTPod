...
##Scenario:: Test Case 111651: TC08_Validating_CAN Online_Personal Details in summary page_Refinance Parent Loan_SK State address & Child Loan NON SK Flinks eligible province
Feature: CAN_Online_TC39_Refinance_NonFlinks_SK_Province

  @ILRefinanceApproved
  Scenario: Online_IL_Refinance loan and withdraw loan|TC39_Refinance_NonFlinks_SK_pro
    Given Genareted sin
