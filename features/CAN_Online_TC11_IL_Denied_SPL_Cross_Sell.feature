##Scenario::Test case 60300: TS_21_Online_New Customer_IL_Cross-Sell_SPL_Flinks Opt out_Approved
Feature: Online_New Customer_IL_Credit Declined

  @ILLoandenied
  Scenario: Online_New Customer_IL_Credit Declined|TC_11_IL_SPLdenied
    Given Genareted sin
