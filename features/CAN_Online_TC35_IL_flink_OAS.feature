##Scenario: Test Case 102064: TC04_CAN_Online_IL_ Flinks_Verify the system should display the income source received from Flinks for "Old Age Security"

Feature: Test Case 102064: TC04_CAN_Online_IL_ Flinks_Verify the system should display the income source received from Flinks for "Old Age Security"

  @ILApprovedd
  Scenario: Test Case 102064: TC04_CAN_Online_IL_ Flinks_Verify the system should display the income source received from Flinks for "Old Age Security"|CAN_Online_TC35_IL_flink_OAS
