...
##Scenario::Test case 60334: TS_55_Refinance- Auto Void
Feature: Online_IL_Refinance loan and void loan

  @ILRefinanceApproved
  Scenario: Online_IL_Refinance loan and void loan|TC_20_Refinance_void 
    Given Genareted sin
